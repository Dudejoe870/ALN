...
curl_xferinfo_callback :: proc "c" (
	clientp: rawptr,
	dltotal, dlnow, ultotal, ulnow: curl_off_t,
) -> c.int
...
CurlGlobalFlagBits :: enum {
	CURL_GLOBAL_SSL,
	CURL_GLOBAL_WIN32,
}
CurlGlobalFlags :: bit_set[CurlGlobalFlagBits; c.long]
CURL_GLOBAL_ALL :: CurlGlobalFlags { 
	.CURL_GLOBAL_SSL, 
	.CURL_GLOBAL_WIN32,
}
...
foreign libcurl {
	curl_global_init    :: proc(flags: CurlGlobalFlags) -> CURLcode ---
	...
	curl_easy_strerror  :: proc(err: CURLcode) -> cstring ---
